...
$THEME->sheets = ['custom-header', 'mod-hsuforum', 'flags16', 'course-content', 'legend', 'groupselect', 'blocks', 'custom-footer', 'custom-notes', 'custom-login', 'skin_v1'];

if ($THEME->settings->enablecustomaccessibility) {
    $THEME->sheets = ['custom-header', 'mod-hsuforum', 'flags16', 'course-content', 'legend', 'groupselect', 'blocks', 'custom-footer', 'custom-notes', 'custom-login', 'skin_v1', 'accessibility'];
}
...
// This setting list the javascript we want to include in our theme.
// List the name of a file in the /javascript/ folder for our theme without any js file
// extensions.

$THEME->javascripts = array('jquery.dd', 'custom-notes', 'ace', 'mode-php', 'theme-dawn');
...
$THEME->layouts = [
    ...
    // The pagelayout used for login page.
    'login' => array(
        'file' => 'login.php',
        'regions' => array('side-pre', 'footer'),
        'defaultregion' => 'side-pre',
...
$THEME->csspostprocess = 'theme_legend_process_css';
$THEME->iconsystem = 'theme_legend_icon_system_fontawesome';