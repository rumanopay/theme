...
$string['choosereadme'] = 'Theme photo is a child theme of Boost. New theme for GS OLC';
// The name of our plugin.
$string['pluginname'] = 'Legend';
...
// Sponsor.
$string['sponsor_title'] = 'Sponsor Legend';
$string['sponsor_desc'] = 'Please sponsor via PayPal by contacting me via my \'';
$string['sponsor_desc2'] = ' to keep the Legend development going, or simply to express your gratitude.';
...
// Readme.
$string['readme_title'] = 'Legend read-me';
$string['readme_desc'] = 'Please {$a->url} containing more information about the Legend theme.';
...
$string['logodesc'] = 'Please upload your custom logo here if you want to add it to the header.
                       <br>If you upload a logo it will replace the standard icon that was displayed by default. To remove the name set Header title to No Title';
...
$string['credit'] = 'The Legend theme is developed, enhanced and maintained by ';
...
$string['brandicon'] = 'Custom brandicon';
$string['brandicondesc'] = 'Upload your own brandicon.';
...
// HSU Forum
$string['postfromx'] = 'Reply from {$a->author} {$a->parentpost}';

//Display FLAG & TIME
$string['display_flag_and_time'] = 'Display country flag and time';
$string['display_flag_and_time_desc'] = 'Display the flag of the country of the user and the time of the country';

//Enable Elevio help tab
$string['enable_help_tab'] = 'Enable help tab';
$string['enable_help_tab_desc'] = 'Display the Elevio help tab';

//Settings Tabs
$string['generalsettings'] = 'General';
$string['coloursettings'] = 'Colour';
...
$string['icon_filter_desc'] = 'A CSS filter function to apply to all activity icons.';

//Page section width settings
$string['page_max_width'] = 'Page max width';
$string['page_max_width_desc'] = 'The maximum width of the page content area when using the responsive layout. Can be in px or %.';

//Elevio account_id
$string['elevio_account_id'] = 'Elevio account_id';
$string['elevio_account_id_desc'] = 'The account_id used in the Elevio help tab script';

// Login message top on login page
$string['login_message_top'] = 'Login message top';
$string['login_message_top_desc'] = 'A message to be displayed above the login form.';

// Login message bottom on login page
$string['login_message_bottom'] = 'Login message bottom';
$string['login_message_bottom_desc'] = 'A message to be displayed below the login form.';

// Show or hide course name.
$string['display_course_name'] = 'Display Course Name on Course Pages';
$string['display_course_name_desc'] = 'Display or hide the course name which appears at the top of every course page';

// Image to display on Login Page
$string['login_background_image'] = 'Login background image';
$string['login_background_image_desc'] = 'A background image for the login page.';

// Image to display on Login Page for mobile devices
$string['login_background_image_mobile'] = 'Login background image mobile';
$string['login_background_image_mobile_desc'] = 'A background image for the login page to be used on smaller screens.';

// Vidoe to display on Login page
$string['login_background_video'] = 'Login background video';
$string['login_background_video_desc'] = 'A background video for the login page.';

$string['login_logo'] = 'Logo';
$string['loginlogodesc'] = 'Please upload your custom logo here if you want to add it to the header.
                       <br>If you upload a logo it will replace the standard icon that was displayed by default. To remove the name set Header title to No Title';

$string['login_logo_height'] = 'Logo height';
$string['loginlogoheightdesc'] = 'The height of the logo image. This can be specified in px or em.';

$string['login_logo_width'] = 'Logo width';
$string['loginlogowidthdesc'] = 'The width of the logo image. This can be specified in px or em.';

$string['login_text_color'] = 'Login text colour';
$string['logintextcolordesc'] = 'Colour of font visible on login page';

// Settings page title
$string['configtitle'] = 'Legend';

// Login page setting tab title
$string['loginpagesettings'] = 'Login Page';

// Login page setting tab title
$string['footersettings'] = 'Footer';

$string['themelabelcolor'] = '<label> Colour';
$string['themelabelcolordesc'] = 'Colour of all label text on page';

$string['themepcolor'] = '<p> tag Colour';
$string['themepcolordesc'] = 'Colour of all paragraf text on page';

$string['themespancolor'] = '<span> tag colour';
$string['themespancolordesc'] = 'Colour of all span text on page';

$string['themedropdownitemcolor'] = 'dropdown-item colour';
$string['themedropdownitemcolordesc'] = 'Colour of all .drop-down text on page';

$string['skin_v1_heading'] = 'Skin V1';

$string['showcourseblocklogo'] = 'Course block logo';
$string['showcourseblocklogodesc'] = 'Show partner logo in course block';

$string['bodybackgroundcolour'] = 'Theme body background colour';
$string['bodybackgroundcolourdesc'] = 'Colour for the theme body';

$string['cardborder'] = 'Card border';
$string['cardborderdesc'] = 'Border for cards (white blocks)';

$string['cardborderradius'] = 'Card border-radius';
$string['cardborderradiusdesc'] = 'Border-radius for cards (white blocks)';

$string['linkcolour'] = 'Link Colour';
$string['linkcolourdesc'] = 'All a tags in theme';

$string['linkfontweight'] = 'Link font-weight';
$string['linkfontweightdesc'] = 'Font wieght of all links in theme';

$string['linkborderbottom'] = 'Link border-bottom';
$string['linkborderbottomdesc'] = 'Border-bottom of all links in theme';

$string['linkhovercolour'] = 'Link hover colour';
$string['linkhovercolourdesc'] = 'Colour for when hovering on link';

$string['linkhoverborderbottomstyle'] = 'Link hover border-bottom-style';
$string['linkhoverborderbottomstyledesc'] = 'Border-bottom when hovering on link';

$string['linkhovertextdecoration'] = 'Link hover text-decoration';
$string['linkhovertextdecorationdesc'] = 'Decoration for hovering on link';

$string['themeheaderbordercolour'] = 'Header colour';
$string['themeheaderbordercolourdesc'] = 'Colour for the border botoom of the header.';

$string['customnotifications_settings'] = 'Notifications';
$string['enablecustomnotifications'] = 'Enable';
$string['enablecustomnotificationsdesc'] = 'Enable custom notifications (theme only).';
$string['unreadnotificationcountcolour'] = 'Badge colour';
$string['unreadnotificationcountcolourdesc'] = 'Custom notification unread count badge colour.';
$string['customnotificationsubjectsubmissiongraded'] = 'Subject';
$string['customnotificationsubjectsubmissiongradeddesc'] = 'Subject for the grading notification';

$string['enableadvancedforumnotifications'] = 'Hsu Forum notifications';
$string['enableadvancedforumnotificationsdesc'] = 'Enable Hsu Forum notifications (theme only).';

$string['hideadvancedforumpostsnotifications'] = 'Hide Hsu forum notifications';
$string['hideadvancedforumpostsnotificationsdesc'] = 'Hide Hsu forum notifications (theme only).';

$string['customiconcolour_settings'] = 'Custom Icon Colour';
$string['enablecustomiconcolour'] = 'Enable js to change icon colourse';
$string['enablecustomiconcolourdesc'] = 'Use this to enable/disable icon colour change';
$string['customiconbasecolour'] = 'Base colour';
$string['customiconbasecolourdesc'] = 'Colour to be changed in the icon';
$string['customiconnewcolour'] = 'New colour';
$string['customiconnewcolourdesc'] = 'Color the icon needs to change to';

$string['customfileuploadprogressbar_settings'] = 'Upload progress bar';
$string['enablecustomfileuploadprogressbar'] = 'Enable progress bar';
$string['enablecustomfileuploadprogressbaresc'] = 'Enable the progress bar';
$string['customfileuploadprogressbartextcompelete'] = 'Completion text';
$string['customfileuploadprogressbartextcompeletedesc'] = 'Show text when file is done uploading';
$string['customfileuploadprogressbarbackgroundcolour'] = 'Bar colour';
$string['customfileuploadprogressbarbackgroundcolourdesc'] = 'Background colour of bar';
$string['customfileuploadprogressbarbackgroundcolourcomplete'] = 'Complete bar colour';
$string['customfileuploadprogressbarbackgroundcolourcompletedesc'] = 'Background colour when done uploading';
$string['customfileuploadprogressbarfontcolour'] = 'Font colour';
$string['customfileuploadprogressbarfontcolourdesc'] = 'Font colour inside bar';
$string['customfileuploadprogressbarfontcolourcomplete'] = 'Font colour complete';
$string['customfileuploadprogressbarfontcolourcompletedesc'] = 'Font colour inside bar when done uploading';

$string['coursecalendar'] = 'Course Calendar';
$string['mycoursesbreadcrumb'] = 'My Courses';
$string['gradesbreadcrumb'] = 'Grades';

$string['themedropdownitemcolorlordesc'] = 'Drop down item colour';
$string['themepdesc'] = 'Paragraph colour';

$string['accessibilitysettings'] = 'Accessibility';
$string['enablecustomaccessibility'] = 'Enable';
$string['enablecustomaccessibilitydesc'] = 'Enable custom accessibility changes';
